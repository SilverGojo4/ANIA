...
def write_fasta_file(input_path: str, output_fasta: str) -> None:
    """
    Load a sequence table from a file and write it to a FASTA file.

    Parameters
    ----------
    input_path : str
        Path to the input file containing sequence data (supports .csv, .tsv, .xlsx, .xls).
    output_fasta : str
